...
Each exit criterion requires passing focused tests and ledger evidence.

- [ ] 01 — Workspace, CI, ledger, KCL/CLA/NOTICE, and exhaustive CTFd parity
  inventory exist; base format/lint checks pass.
- [ ] 02 — Core domain, scoring, typed events, adapters, four modes, migrations,
  and PostgreSQL store pass unit/integration tests.
- [ ] 03 — Secured REST/WS/SSE API, full auth/RBAC/audit, and OpenAPI contracts
...
- [ ] 09 — Typed automation DAG, visual editor, execution history, dry-run,
  SSRF-safe actions, and signed webhook delivery work.
...
- [ ] 14 — Unit, integration, contract, component, E2E, axe, and 10k load tests
  meet gates; CI, scans, coverage, and performance budgets pass.
- [ ] 15 — Starlight documentation and generated API reference are accurate and
  build; rich seed data works.
- [ ] 16 — Original hand-authored Kon state art, restrained animation, identity,
