...
export type OAuthClient = components['schemas']['OAuthClientResponse'];
export type CreatedOAuthClient = components['schemas']['CreatedOAuthClientResponse'];
export type CreateOAuthClientInput = components['schemas']['CreateOAuthClientRequest'];
...
export type ApiTokenSummary = components['schemas']['ApiTokenResponse'];
export type CreatedApiToken = components['schemas']['CreatedApiTokenResponse'];
...
export type RecoveryCodes = components['schemas']['RecoveryCodesResponse'];
export type HealthSummary = components['schemas']['HealthResponse'];
export type ReadinessSummary = components['schemas']['ReadinessResponse'];
