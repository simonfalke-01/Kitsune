...
import { Avatar, Button, Dialog, DialogTrigger } from '@/components/ui';
  ...
  return (
    ...
    >
      ...
      <DialogTrigger>
        ...
        <Dialog size="wide" title="Team attempts">
          <div className="grid gap-2">
            ...
            <ol aria-label="Shared attempt history" className="m-0 grid list-none gap-2 p-0">
